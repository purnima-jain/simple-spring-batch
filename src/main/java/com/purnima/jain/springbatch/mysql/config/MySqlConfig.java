package com.purnima.jain.springbatch.mysql.config;
...
@EnableJpaRepositories(
		...
		basePackages = { "com.purnima.jain.springbatch.mysql" })
public class MySqlConfig {
	...
	public LocalContainerEntityManagerFactoryBean mySqlEntityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("mySqlDataSource") DataSource dataSource) {
		return builder
				...
				.packages("com.purnima.jain.springbatch.mysql.entity")
				.build();
	}
	...
	public DataSourceInitializer mySqldataSourceInitializer(@Qualifier("mySqlDataSource") DataSource mySqlDataSource) {
		...
		// resourceDatabasePopulator.addScript(new ClassPathResource("mysql/schema-batch-mysql.sql")); // To create the Spring-Batch tables
