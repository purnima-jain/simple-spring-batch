package com.purnima.jain.springbatch.postgres.config;
...
@EnableJpaRepositories(
		...
		basePackages = { "com.purnima.jain.springbatch.postgres" })
public class PostgresConfig {
	...
	public LocalContainerEntityManagerFactoryBean mySqlEntityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("postgresDataSource") DataSource dataSource) {
		return builder
				...
				.packages("com.purnima.jain.springbatch.postgres.entity")
				.build();
	}
